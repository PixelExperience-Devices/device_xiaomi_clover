...
libmm-venc-inc      += device/xiaomi/clover/oss-hals/media/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += device/xiaomi/clover/oss-hals/media/mm-core/inc
libmm-venc-inc      += device/xiaomi/clover/oss-hals/media/libstagefrighthw
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/adreno
libmm-venc-inc      += device/xiaomi/clover/oss-hals/media/libc2dcolorconvert
libmm-venc-inc      += device/xiaomi/clover/oss-hals/media/hypv-intercept
