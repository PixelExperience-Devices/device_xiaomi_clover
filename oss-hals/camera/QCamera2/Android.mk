...
LOCAL_C_INCLUDES := \
        ...
        $(LOCAL_PATH)/util \
        $(LOCAL_PATH)/HAL3 \
        device/xiaomi/clover/oss-hals/media/libstagefrighthw \
        device/xiaomi/clover/oss-hals/media/mm-core/inc \
...
LOCAL_C_INCLUDES += \
         device/xiaomi/clover/oss-hals/camera/QCamera2/HAL
...
LOCAL_C_INCLUDES += \
        device/xiaomi/clover/oss-hals/display/libqservice
