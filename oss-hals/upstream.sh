...
git subtree pull --prefix=qcom-caf/display/display-commonsys-intf https://git.codelinaro.org/clo/la/platform/vendor/qcom-opensource/display-commonsys-intf $clobranch
